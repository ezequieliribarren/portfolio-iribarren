...
const SobreMi = () => {
  return (
    <section id='sobre-mi'>
      <div className='title-section'><h3>Sobre mi</h3><span className='arrow'>→</span></div>
      <p>
        Hace varios años, mis metas se vinculan con la programación. En este tiempo he adquirido conocimientos en desarrollo web. 
      </p>
      <p>
